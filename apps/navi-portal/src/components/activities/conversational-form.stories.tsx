...
const meta: Meta<typeof ConversationalForm> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A multi-step conversational form component designed for healthcare applications. Features validation, progress tracking, and accessibility compliance (WCAG 2.1 AA).",
      },
    },
  },
  args: {
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        description:
          "I would like to receive health tips and appointment reminders",
      },
    ],
  },
];
...
export const PatientIntake: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "A comprehensive patient intake form for healthcare providers. Includes personal information, contact details, medical history, and consent preferences.",
      },
    },
  },
};
...
export const ContactForm: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "A simple two-step contact form with subject selection and message composition.",
      },
    },
  },
};
...
export const SingleStep: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "A single-step form that still uses the conversational form structure for consistency.",
      },
    },
  },
};
...
export const ValidationExample: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates various validation rules including required fields, length constraints, and format validation.",
      },
    },
  },
};
