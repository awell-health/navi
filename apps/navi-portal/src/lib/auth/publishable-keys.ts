...
const DEVELOPMENT_KEYS: PublishableKeyData[] = [
  ...
  },
  {
    ...
    tenantId: "sunrise-health-tenant",
    environment: "development",
    allowedDomains: ["localhost:3000", "localhost:3001", "sunrise.health.com"],
    isActive: true,
  },
  {
    key: "pk_test_customer_demo_456",
    orgId: "customer-demo",
    tenantId: "customer-demo-tenant",
    environment: "development",
    allowedDomains: ["localhost:3000", "localhost:3001", "demo.customer.com"],
    isActive: true,
  },
  {
