...
describe("Branding Validator", () => {
  it("should validate valid branding with all optional fields", () => {
    const validBranding = {
      ...
      onPrimary: "#FFFFFF",
      background: "#FAFAFA",
      logoUrl: "https://cdn.awellhealth.com/logo.svg",
      faviconUrl: "https://cdn.awellhealth.com/favicon.ico",
    ...
    if (result.success) {
      expect(result.data.faviconUrl).toBe(
        "https://cdn.awellhealth.com/favicon.ico"
      );
      expect(result.data.logoUrl).toBe("https://cdn.awellhealth.com/logo.svg");
    }
  });
  ...
  it("should validate favicon with different protocols", () => {
    const validBrandings = [
      ...
      { faviconUrl: "https://cdn.awellhealth.com/assets/favicon.svg" },
    ];
