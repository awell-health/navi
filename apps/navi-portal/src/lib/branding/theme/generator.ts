...
export function brandingToTokens(
  ...
  if (branding.radiusMd && typeof branding.radiusMd === "string") {
    ...
    const radiusValue =
      branding.radiusMd.replace(/var\(--radius\w*\)/, "").trim() ||
      branding.radiusMd;
  ...
  if (branding.primaryHover && typeof branding.primaryHover === "string") {
    tokens["--primary-dark"] = sanitizeCSSValue(branding.primaryHover);
  }

  if (
    branding.primaryDisabled &&
    typeof branding.primaryDisabled === "string"
  ) {
    tokens["--primary-disabled"] = sanitizeCSSValue(branding.primaryDisabled);
  }
...
export function generateFontCSS(
  ...
  if (branding.fontFamilyBody && typeof branding.fontFamilyBody === "string") {
    fontCSS += `  --font-family-body: ${sanitizeCSSValue(
      branding.fontFamilyBody
    )};\n`;
  }
  ...
  if (branding.fontSizeBase && typeof branding.fontSizeBase === "string") {
    fontCSS += `  --font-size-base: ${sanitizeCSSValue(
      branding.fontSizeBase
    )};\n`;
  }
  ...
  if (branding.fontSize2xl && typeof branding.fontSize2xl === "string") {
    fontCSS += `  --font-size-2xl: ${sanitizeCSSValue(
      branding.fontSize2xl
    )};\n`;
  }

  if (branding.fontSize3xl && typeof branding.fontSize3xl === "string") {
    fontCSS += `  --font-size-3xl: ${sanitizeCSSValue(
      branding.fontSize3xl
    )};\n`;
  }

  if (branding.fontSize4xl && typeof branding.fontSize4xl === "string") {
    fontCSS += `  --font-size-4xl: ${sanitizeCSSValue(
      branding.fontSize4xl
    )};\n`;
  }

  // Line heights
  if (
    branding.lineHeightTight &&
    typeof branding.lineHeightTight === "string"
  ) {
    fontCSS += `  --line-height-tight: ${sanitizeCSSValue(
      branding.lineHeightTight
    )};\n`;
  }

  if (
    branding.lineHeightNormal &&
    typeof branding.lineHeightNormal === "string"
  ) {
    fontCSS += `  --line-height-normal: ${sanitizeCSSValue(
      branding.lineHeightNormal
    )};\n`;
  }

  if (
    branding.lineHeightRelaxed &&
    typeof branding.lineHeightRelaxed === "string"
  ) {
    fontCSS += `  --line-height-relaxed: ${sanitizeCSSValue(
      branding.lineHeightRelaxed
    )};\n`;
  }
  ...
  // Font weights
  if (
    branding.fontWeightNormal &&
    typeof branding.fontWeightNormal === "string"
  ) {
    fontCSS += `  --font-weight-normal: ${sanitizeCSSValue(
      branding.fontWeightNormal
    )};\n`;
  }

  if (
    branding.fontWeightMedium &&
    typeof branding.fontWeightMedium === "string"
  ) {
    fontCSS += `  --font-weight-medium: ${sanitizeCSSValue(
      branding.fontWeightMedium
    )};\n`;
  }

  if (
    branding.fontWeightSemibold &&
    typeof branding.fontWeightSemibold === "string"
  ) {
    fontCSS += `  --font-weight-semibold: ${sanitizeCSSValue(
      branding.fontWeightSemibold
    )};\n`;
  }

  if (branding.fontWeightBold && typeof branding.fontWeightBold === "string") {
    fontCSS += `  --font-weight-bold: ${sanitizeCSSValue(
      branding.fontWeightBold
    )};\n`;
  }

  if (
    branding.fontWeightExtrabold &&
    typeof branding.fontWeightExtrabold === "string"
  ) {
    fontCSS += `  --font-weight-extrabold: ${sanitizeCSSValue(
      branding.fontWeightExtrabold
    )};\n`;
  }
...
function generateTypographyClasses(branding: OrgBranding["branding"]): string {
  ...
  .navi-h1 {
    ...
    font-size: ${
      branding.fontSize4xl ? sanitizeCSSValue(branding.fontSize4xl) : "2.25rem"
    };
    line-height: ${
      branding.lineHeightTight
        ? sanitizeCSSValue(branding.lineHeightTight)
        : "1.25"
    };
    font-weight: ${
      branding.fontWeightExtrabold
        ? sanitizeCSSValue(branding.fontWeightExtrabold)
        : "800"
    };
  }
  ...
  .navi-h2 {
    font-family: ${headingFamily};
    font-size: ${
      branding.fontSize3xl ? sanitizeCSSValue(branding.fontSize3xl) : "1.875rem"
    };
    line-height: ${
      branding.lineHeightTight
        ? sanitizeCSSValue(branding.lineHeightTight)
    ...
    font-weight: ${
      branding.fontWeightSemibold
        ? sanitizeCSSValue(branding.fontWeightSemibold)
        : "600"
    };
  }
  ...
  .navi-h3 {
    font-family: ${headingFamily};
    font-size: ${
      branding.fontSize2xl ? sanitizeCSSValue(branding.fontSize2xl) : "1.5rem"
    };
    line-height: ${
      branding.lineHeightTight
        ? sanitizeCSSValue(branding.lineHeightTight)
  ...
  .navi-h4 {
    font-family: ${headingFamily};
    font-size: ${
      branding.fontSizeXl ? sanitizeCSSValue(branding.fontSizeXl) : "1.25rem"
    };
    line-height: ${
      branding.lineHeightTight
        ? sanitizeCSSValue(branding.lineHeightTight)
    ...
    font-weight: ${
      branding.fontWeightMedium
        ? sanitizeCSSValue(branding.fontWeightMedium)
        : "500"
    };
  }
  ...
  .navi-p {
    ...
    font-size: ${
      branding.fontSizeBase ? sanitizeCSSValue(branding.fontSizeBase) : "1rem"
    };
    line-height: ${
      branding.lineHeightRelaxed
        ? sanitizeCSSValue(branding.lineHeightRelaxed)
        : "1.625"
    };
    font-weight: ${
      branding.fontWeightNormal
        ? sanitizeCSSValue(branding.fontWeightNormal)
        : "400"
    };
  }
  ...
  .navi-lead {
    ...
    line-height: ${
      branding.lineHeightNormal
        ? sanitizeCSSValue(branding.lineHeightNormal)
        : "1.5"
    };
    font-weight: ${
      branding.fontWeightNormal
  ...
  .navi-large {
    font-family: ${bodyFamily};
    font-size: ${
      branding.fontSizeLg ? sanitizeCSSValue(branding.fontSizeLg) : "1.125rem"
    };
    line-height: ${
      branding.lineHeightNormal
        ? sanitizeCSSValue(branding.lineHeightNormal)
  ...
  .navi-small {
    font-family: ${bodyFamily};
    font-size: ${
      branding.fontSizeSm ? sanitizeCSSValue(branding.fontSizeSm) : "0.875rem"
    };
    line-height: ${
      branding.lineHeightTight
        ? sanitizeCSSValue(branding.lineHeightTight)
 ...
 */
export function generateFaviconHTML(
  branding: OrgBranding["branding"] | null
): string {
