...
const ComponentShowcase = ({ children, title }: { children: React.ReactNode; title: string }) => (
...
const ButtonMeta: Meta<typeof Button> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A button component built with Radix UI primitives and styled with Tailwind CSS. Supports multiple variants and sizes.'
      }
    }
  },
  argTypes: {
...
export const TextareaStories: Meta<typeof Textarea> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A textarea component for multi-line text input with consistent styling.'
      }
    }
  },
  argTypes: {
...
export const TextareaWithLabel: StoryObj<typeof TextareaStories> = {
  render: () => (
    <div className="space-y-2 w-80">
      ...
      <Textarea id="feedback" placeholder="Please share your thoughts..." rows={4} />
    </div>
  ),
  parameters: {
    docs: {
...
export const CheckboxStories: Meta<typeof Checkbox> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A checkbox component built with Radix UI for accessibility and customization.'
      }
    }
  },
  argTypes: {
...
export const CheckboxGroup: StoryObj<typeof CheckboxStories> = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          {['Email notifications', 'SMS alerts', 'Push notifications', 'Weekly digest'].map((item) => (
  ...
  parameters: {
    docs: {
      description: {
        story: 'Multiple checkboxes working together as a group with state management.'
      }
    }
  }
};
...
export const RadioGroupStories: Meta<typeof RadioGroup> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A radio group component built with Radix UI for mutually exclusive selection.'
      }
    }
  }
};
...
export const BasicRadioGroup: StoryObj<typeof RadioGroupStories> = {
  render: () => {
    ...
    return (
      <div className="space-y-4">
        <div className="font-medium">How comfortable are you with technology?</div>
...
export const AllComponents: StoryObj = {
      ...
      <div className="max-w-2xl space-y-6 p-6">
        ...
        <ComponentShowcase title="Checkbox">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="newsletter">Subscribe to health tips newsletter</Label>
          </div>
        </ComponentShowcase>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="normal">Normal - Response within 24 hours</Label>
              </div>
              <div className="flex items-center space-x-2">
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'A comprehensive showcase of all UI components working together in a healthcare form context.'
      }
    }
  }
};